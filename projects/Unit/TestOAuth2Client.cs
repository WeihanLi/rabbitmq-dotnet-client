...
namespace RabbitMQ.Client.Unit
{
    public class TestOAuth2Client
    {
        ...
        {
            JsonToken expectedJsonToken = new JsonToken("the_access_token", "the_refresh_token", 10);
            ...
            Assert.Equal(token.ExpiresIn, expectedJsonToken.expires_in);
        }
        ...
        public void TestRefreshToken()
        {
            ...
            expectedJsonToken = new JsonToken("the_access_token2", "the_refresh_token", 20);
            expectTokenRequest(new RequestFormMatcher()
                            .WithParam("client_id", _client_id)
                            .WithParam("client_secret", _client_secret)
                            .WithParam("grant_type", "refresh_token")
            ...
            Assert.Equal(refreshedToken.ExpiresIn, expectedJsonToken.expires_in);
        }
